...
export default function AboutSection() {
    const whatIsAR = "Augmented Reality (AR) is a technology that creates an interactive experience where virtual objects are seen in the real world. Imagine looking through your phone and seeing digital objects or information layered on top of what you see in real life.";
    const treasureHuntDescription = "A treasure hunt is a game where participants search for clues, often solving puzzles to find the final prize. Traditionally, it involves moving from one location to another, solving clues, and working as a team to uncover the treasure.";
    ...
    return (
        <div className="ground-tile-bg md:p-8 text-white" id='about-section'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-moussaka border-none">
                    <CardHeader>
