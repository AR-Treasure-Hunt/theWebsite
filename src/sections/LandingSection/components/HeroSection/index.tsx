...
const HeroSection: React.FC = () => {
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#F0EBFF]">
      {/* Main Content */}
      <div className="container px-[5vh] sm:px-[10vh] lg:px-0 md:pl-[13vh] lg:pl-[18vh] md:pr-[6vh] pt-[9vh] sm:pt-[12vh] md:pt-[19vh] lg:pt-[20vh] xl:pt-[17vh] text-[#003F5A] z-30 relative">
        ...
        <div className="flex flex-col md:flex-row items-start gap-[2vh] self-stretch mt-[1.5vh] lg:mt-[2vh] xl:mt-[2.5vh] w-full">
          ...
          <a
            href="#"
            className="flex justify-center items-center bg-[#003F5A] text-white text-[2.5vh] sm:text-[3vh] lg:text-[3.5vh] xl:text-[4vh] rounded-lg hover:bg-[#002a3d] transition-colors whitespace-nowrap py-[0.6vh] px-[1vh] md:py-[1.2vh] md:px-[2.5vh] lg:py-[1.75vh] lg:px-[3vh] xl:py-[1.2vh]"
          >
            Join The Adventure
          </a>
          {/* Learn More Button */}
          <a
            href="#"
            className="flex justify-center items-center text-[#003F5A] text-[2.5vh] sm:text-[3vh] lg:text-[3.5vh] xl:text-[4vh] backdrop-blur border-[0.3vh] lg:border-[0.3vh] border-[#003F5A] hover:bg-[#f0f0f0] transition-colors whitespace-nowrap py-[0.5vh] px-[4.2vh] sm:px-[4.8vh]  md:px-[2.5vh]  md:py-[1vh] lg:py-[1.5vh] lg:px-[2.5vh] xl:py-[1vh] rounded-lg"
          >
            Learn More
          </a>
        </div>
      ...
      <ResponsivePixelArtImage
        ...
        alt="Cloud Upper"
        sizes={{
          default:{ show: true, width: 'auto', height: '9%', position: { right: '-10%', top: '17%'} },
          sm: { show: true, width: 'auto', height: '10.5%', position: { right: '0', top: '5%' } },
      ...
      <ResponsivePixelArtImage
        ...
        alt="Cloud Lower"
        sizes={{
          default: {show: true, width: 'auto', height: '9%', position: { left: '-15%', top: '35%' }  },
          sm: { show: true, width: 'auto', height: '10.5%', position: { left: '-3%', top: '41%' } },
      ...
      <ResponsivePixelArtImage
        ...
        alt="Mountains"
        sizes={{
          default:{ show: true, width: '100%', height: '25%', position: { bottom: '11%', left: '0' }},
      ...
      <ResponsivePixelArtImage
        ...
        alt="Ground"
        sizes={{
          default:{ show: true, width: '100%', height: '6%', position: { bottom: '6%', left: '0', right: '0', zIndex: '20' } },
          sm: { show: true, width: '100%', height: '6%', position: { bottom: '6%', left: '0', right: '0', zIndex: '20' } },
          md: { show: true, width: '100%', height: '7%', position: { bottom: '6%', left: '0', right: '0', zIndex: '20' } },
          lg: { show: true, width: 'auto', height: '10%', position: { bottom: '6%', left: '0', right: '0', zIndex: '20' } },
          xl: { show: true, width: 'auto', height: 'auto', position: {bottom: '6%', left: '0', right: '0', zIndex: '20' } },
          '2xl': { show: true, width: 'auto', height: 'auto', position: { bottom: '6%', left: '0', right: '0', zIndex: '20'}},
        }}
      />
      <ResponsivePixelArtImage
        src={assets.Pik}
      ...
      <ResponsivePixelArtImage
        ...
        alt="Temple"
        sizes={{
          default:{ show: true, width: 'auto', height: '7%', position: { left: '55%', bottom: '11.4%', zIndex: '10' }},
      ...
      <ResponsivePixelArtImage
        ...
        alt="Tree 1"
        sizes={{
          default: { show: true, width: 'auto', height: '7%', position: { left: '37%', bottom: '11.3%', zIndex: '10' } },
      ...
      <ResponsivePixelArtImage
        ...
        alt="Tree 2"
        sizes={{
          default: { show: true, width: 'auto', height: '7%', position: { left: '26%', bottom: '11.3%', zIndex: '10' } },
      ...
      <ResponsivePixelArtImage
        ...
        alt="Tree R"
        sizes={{
          default:  { show: true, width: 'auto', height: '7%', position: { left: '77%', bottom: '11.3%', zIndex: '10' }},
