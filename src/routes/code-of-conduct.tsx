        ...
        <Card className="mb-8 bg-[#F0EBFF] text-[#003F5A]">
          ...
          <CardContent>
            <p className="mb-4 text-lg font-normal  font-rubik text-primary">
              ...
              Any incident during the Treasure Hunt resulting in injury or worse may mean the end of
              the Hunt. Recognize that the success of the Hunt is designed to be based upon clue
              complexity and your ability to solve them. Moreover, if we consider the uncertain
              conditions, there might be the chances of rainfall, as well, because most of the
            ...
            <Accordion type="single" collapsible className="mb-8 font-rubik text-primary">
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-xl">
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Treat all participants, organizers, and audiences with respect and courtesy.
                    </li>
                    <li>
                      Prioritize safety during the event. Be aware of your surroundings, and avoid
                      dangerous actions that could harm yourself or others.
                    </li>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-xl">
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Teams are encouraged to have a mobile phone/laptop with internet access.
                    </li>
                    <li>
                      By participating in this event, you agree to be live-streamed on the internet
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-xl">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Trolling, using insulting language, or engaging in personal or political
                      attacks.
                    </li>
                    <li>
                      Using sexualized language or imagery and giving unwelcome sexual attention.
                    </li>
        ...
        <Card className="bg-[#F0EBFF] text-[#003F5A]">
          ...
          <CardContent className="text-lg font-rubik text-primary">
            <p>
              ...
              issues will be reviewed fairly and in a timely manner. If found guilty of not abiding
              by the code of conduct, the person shall have severe consequences, including but not
              limited to revocation of club membership, disqualification from the event, and
              blacklisting from further participation.
            </p>
          </CardContent>
        </Card>
      </div>
